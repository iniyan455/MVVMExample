...
/**
 * Extends RoomDatabase and method should be abstract and annotation as @Database
 */
abstract class AppDatabase : RoomDatabase() {
     ...
     */
    companion object {
        // Immeditately visible to all the thread
        @Volatile
        ...
        // when we create appdatabase we need to pass context to invoke method check if instance
        // is not null it will returns the instance help of the operator
